<template>
  <div class="row" id="file_delete">
    <div class="col-12">
      <div class="row mb-2">
        <div class="col-xl-6 offset-xl-3">
          <h1>删除文件-{{ $route.params.fileID }}</h1>
        </div>
      </div>
      <div class="row">
              ...
              <div class="row">
                <div class="col-xl-10 offset-xl-1">
                  <div class="alert alert-danger">
                    ...
                    <p>当您再三确认后，点击下方的按钮以删除该文件！</p>
                    <hr>
                    <button class="btn btn-danger" @click="deleteFile" :disabled="deleteLoading">
                      删除文件
                    </button>
                  </div>
                </div>
      ...
      deleteFile: function () {
        ...
        this.$axios.delete('/file', {
          ...
          if (response.data.statusCode === '1') {
            ...
            this.modalButtonTarget = 'files';
          } else if (response.data.statusCode === '0') {
            console.error('FileDelete操作失败，错误：', response.data.error.message);
            this.modalHeader = '错误';
          ...
          console.error('FileDelete操作失败，错误：', error);
          this.modalHeader = '错误';
