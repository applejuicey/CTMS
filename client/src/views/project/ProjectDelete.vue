<template>
  <div class="row" id="project_delete">
    <div class="col-12">
      <div class="row mb-2">
        <div class="col-xl-6 offset-xl-3">
          <h1>删除项目-{{ $route.params.projectID }}</h1>
        </div>
      </div>
      <div class="row">
              ...
              <div class="row">
                <div class="col-xl-10 offset-xl-1">
                  <div class="alert alert-danger">
                    ...
                    <p>当您再三确认后，点击下方的按钮以删除该项目！</p>
                    <hr>
                    <button class="btn btn-danger" @click="deleteProject" :disabled="deleteLoading">
      ...
      deleteProject: function () {
        ...
        this.$axios.delete('/project', {
          ...
          if (response.data.statusCode === '1') {
            ...
            console.error('ProjectDelete操作失败，错误：', response.data.error.message);
            this.modalHeader = '错误';
          ...
          console.error('ProjectDelete操作失败，错误：', error);
          this.modalHeader = '错误';
